...
class PdfParagraphApi {
  ...
  static Future<File> generate(List<Medicine> med, String Docname, String pname,
      String page, String time) async {
    final pdf = Document();
    final medicine = med;
    final customFont =
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Row(children: [
                          Paragraph(
                              text: 'Medicine Name - ${medicine[index].name}'),
                        ]),
                      ],
                    ),
                    Column(
  ...
  static Widget buildCustomHeader(
          String Docname, String pname, String page, String time) =>
      Container(
