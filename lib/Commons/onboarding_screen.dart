  ...
  List<PageViewModel> getPages() {
    return [
      PageViewModel(
        ...
        body:
            "Our app provide all in one solution for every problem that you can face We got every thing .",
        footer: const Text("created by ❤️ Team3x"),
      ),
      PageViewModel(
        image: Image.network(
        ...
        body:
            "In our app paitent can choose any doctor and can book or shedule a regular appointment .",
      ),
      PageViewModel(
        image: Image.network(
        ...
        body:
            "In our app doctor can accept appointments, manage all appointment keep every data of paitent .",
      ),
      PageViewModel(
        image: Image.network(
            "https://firebasestorage.googleapis.com/v0/b/hospital-management-syst-e9b60.appspot.com/o/onboarding_images%2Fonboard2.png?alt=media&token=649d1b5f-7dcd-4bc8-8fe3-3284f0d41a2b"),
        ...
        body:
            "In our app Admin has multiple functionality , he manage all kinds of medicines what we got in our pharmacy stock, all add new meds.",
      ),
      PageViewModel(
        image: Image.network(
